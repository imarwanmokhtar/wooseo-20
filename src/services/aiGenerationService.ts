...
- SEO Title MUST start with the Primary Focus Keyword exactly and MUST include a POWER WORD (Amazing, Ultimate, Best, Premium, Top, Professional, Advanced, Superior, Exclusive, Perfect, Revolutionary, Outstanding, Exceptional, Incredible, Fantastic) AND a SENTIMENT WORD (Love, Enjoy, Excited, Thrilled, Delighted, Happy, Satisfied, Pleased, Impressed, Wonderful, Excellent, Great, Awesome, Brilliant, Stunning, Beautiful, Perfect, Smart, Easy, Fast, Reliable, Trusted, Proven, Quality)
- SEO Title MUST NOT end with a colon
...
- MANDATORY: Include 3-5 OUTBOUND LINKS to relevant external websites (manufacturer websites, review sites, technology blogs, comparison sites)
...
OUTBOUND LINKS STRATEGY (MANDATORY - RankMath requires these):
You MUST include 3-5 clickable outbound links to relevant external resources in the content:
- Link to manufacturer's official website (e.g., <a href="https://www.anker.com" target="_blank" rel="noopener">Anker Official Website</a>)
- Link to technology review sites (e.g., <a href="https://www.techradar.com" target="_blank" rel="noopener">TechRadar Reviews</a>)
- Link to comparison websites (e.g., <a href="https://www.gsmarena.com" target="_blank" rel="noopener">GSMArena Specifications</a>)
- Link to industry blogs or tech news sites (e.g., <a href="https://www.theverge.com" target="_blank" rel="noopener">The Verge Tech News</a>)
- Link to certification or standards websites when relevant (e.g., <a href="https://www.bluetooth.com" target="_blank" rel="noopener">Bluetooth Official</a>)
...
1. Long Description (600+ words minimum, HTML format):
   ...
   - MANDATORY: Include 3-5 OUTBOUND links to external resources with target="_blank" rel="noopener": <a href="https://external-site.com" target="_blank" rel="noopener">External Resource</a>
...
3. SEO Elements (Optimized for Rank Math SEO Plugin):
   - SEO Meta Title: MUST start with the exact Primary Focus Keyword, include a POWER WORD (Amazing, Ultimate, Best, Premium, Top, Professional, Advanced, Superior, Exclusive, Perfect, Revolutionary, Outstanding, Exceptional, Incredible, Fantastic) AND a SENTIMENT WORD (Love, Enjoy, Excited, Thrilled, Delighted, Happy, Satisfied, Pleased, Impressed, Wonderful, Excellent, Great, Awesome, Brilliant, Stunning, Beautiful, Perfect, Smart, Easy, Fast, Reliable, Trusted, Proven, Quality), be under 60 characters, include a number, and MUST NOT end with a colon
...
OUTBOUND LINKING EXAMPLES (MANDATORY):
- "Learn more about the latest technology at <a href="https://www.techcrunch.com" target="_blank" rel="noopener">TechCrunch</a>."
- "Check detailed specifications on <a href="https://www.gsmarena.com" target="_blank" rel="noopener">GSMArena</a>."
- "Visit the <a href="https://www.anker.com" target="_blank" rel="noopener">official Anker website</a> for more information."
- "Read comprehensive reviews on <a href="https://www.techradar.com" target="_blank" rel="noopener">TechRadar</a>."
- "Compare prices and features on <a href="https://www.rtings.com" target="_blank" rel="noopener">RTINGS</a>."
